...
from langchain_tavily import TavilySearchResults # Professional Search Tool
...
app.config['SQLALCHEMY_ENGINE_OPTIONS'] = {
    "pool_pre_ping": True,
    "pool_recycle": 300,
    "pool_size": 2,        # Conservative limit
    "max_overflow": 5,
    "pool_timeout": 10
}
...
# --- PROFESSIONAL TAVILY SEARCH TOOL ---
@tool
def web_search_tool(query: str) -> str:
    ...
    try:
        ...
        return f"Search Tool Error: {str(e)}. Ensure TAVILY_API_KEY is set."
...
def tool_node(state):
    ...
    for t in tool_calls:
        ...
        if selected_tool:
            # Argument Handling
            valid_args = t["args"]
            # Fallback fix for common hallucination where model nests args
...
def handle_ask():
    ...
    if "simple" in classification:
        ...
        try:
            ...
            final_answer = "I encountered a temporary error. Please check if your TAVILY_API_KEY is set in Render."
