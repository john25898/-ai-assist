...
def ui_builder_tool(prompt: str) -> str:
    ...
    """
    # FIX: Force Inline CSS/JS so the preview works without 404 errors
    messages = [
        SystemMessage(content="""
        You are an expert Frontend Developer. 
        Rules:
        1. Generate clean, modern HTML/Tailwind code. 
        2. MUST use Single-File format: Put CSS in <style> tags and JS in <script> tags inside the HTML. 
        3. Do NOT link to external .css or .js files.
...
def web_search_tool(query: str) -> str:
    """
    Use this tool to find real-time information.
    """
...
def handle_ask():
    ...
    if "simple" in classification:
        ...
        # FIX: Updated System Prompt to prevent XML function calls
        agent_system_message = SystemMessage(content="""
        You are a helpful AI assistant.
        
        CRITICAL RULES:
        1. If you need to use a tool, just output the standard tool call format. DO NOT write XML like <function=...>.
        2. If the user asks about a person, university, or event, you MUST call 'web_search_tool'.
        3. Do NOT say "I don't know". Use the search tool.
        """)
        ...
        try:
            ...
            final_answer = "I'm having trouble right now. Please try asking again in a moment."
