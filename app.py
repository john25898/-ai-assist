...
# --- CRITICAL FIX: Force SQLAlchemy to use the modern 'psycopg' driver ---
# This fixes the "ModuleNotFoundError: No module named 'psycopg2'" error on Python 3.13
raw_db_url = os.environ.get('DATABASE_URL')
if raw_db_url:
    if raw_db_url.startswith("postgres://"):
        app.config['SQLALCHEMY_DATABASE_URI'] = raw_db_url.replace("postgres://", "postgresql+psycopg://", 1)
    elif raw_db_url.startswith("postgresql://"):
        app.config['SQLALCHEMY_DATABASE_URI'] = raw_db_url.replace("postgresql://", "postgresql+psycopg://", 1)
    else:
...
def web_search_tool(query: str) -> str:
    ...
    try:
        # Direct usage of DDGS for stability
...
if db_url and (db_url.startswith("postgresql") or db_url.startswith("postgres")):
    ...
    # Ensure we use the raw URL for the pool, but the app config uses the updated one above
