...
def handle_ask():
    ...
    router_system = "Classify: 1. 'simple' (jokes, greetings). 2. 'complex' (search, code, facts). Return ONLY 'simple' or 'complex'."
    try:
    ...
    if "simple" in classification:
        ...
        try:
            if hasattr(memory_checkpointer, 'setup'):
                with app.app_context(): memory_checkpointer.setup()
