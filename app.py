...
# ==============================================================================
# 2. DEFINE THE TOOLS (All powered by Groq)
# ==============================================================================
...
def web_search_tool(query: str) -> str:
    """
    Use this tool to find real-time information, news, weather, or specific facts about people/places.
    """
...
if db_url and db_url.startswith("postgresql"):
    ...
    # Critical: Keepalives prevent the "SSL connection closed" error
    connection_kwargs = {
        "autocommit": True,
        "prepare_threshold": 0,
        "keepalives": 1,
...
def handle_ask():
    ...
    if "simple" in classification:
        ...
        # --- AGENT EXECUTION (The Fix for Specific Questions) ---
        # We inject a system message forcing the use of tools for unknown info
        agent_system_message = SystemMessage(content="""
        You are a helpful AI assistant.
        
        RULES:
        1. If the user asks about specific people, leadership (VC, CEO), universities, or current events, you MUST use the 'web_search_tool'.
        2. Do NOT guess or say "I don't have up-to-date info". SEARCH FOR IT.
        ...
        # Estimate cost (0.5 credits for using the smart brain/tools)
        cost_estimate = 0.5
