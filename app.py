...
def web_search_tool(query: str) -> str:
    """
    Use this tool to find real-time information, news, weather, current events, or specific facts about people/places.
    """
...
def handle_ask():
    ...
    # We refined this prompt to catch "specific facts" as complex.
    router_system = """
    Classify this prompt into one category:
    1. 'simple': Greetings, jokes, definitions of common words, or basic math.
    2. 'complex': Requests for code, weather, news, specific people/places, current events, or multi-step tasks.
    ...
    if "simple" in classification:
        ...
        # Complex path: The Agency (Uses Web Search if needed)
