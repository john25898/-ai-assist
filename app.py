...
# --- AI IMPORTS (GROQ & TAVILY) ---
from langchain_groq import ChatGroq
# New Professional Search Tool
...
# --- PROFESSIONAL SEARCH TOOL (TAVILY) ---
@tool
def web_search_tool(query: str) -> str:
    ...
    try:
        # Tavily returns clean, AI-ready results (not just raw HTML)
        ...
        for r in results:
            ...
            content = r.get('content', 'No details')
            url = r.get('url', '#')
...
def handle_ask():
    ...
    if "simple" in classification:
        ...
        RULES:
        1. If the user asks about a person, university, or event, you MUST call 'web_search_tool' with a clear query.
        2. Do NOT say "I don't know". Use the search tool.
        """)
        ...
        try:
            ...
            final_answer = "I encountered an error connecting to the internet. Please check your API keys."
