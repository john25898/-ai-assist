...
# --- DATABASE STABILITY (For User DB) ---
...
# --- DATABASE CONNECTION (FIXED WITH RECYCLING) ---
...
if db_url and db_url.startswith("postgresql"):
    ...
    # CRITICAL FIX: Connection Pool with aggressive recycling
    pool = ConnectionPool(
        conninfo=db_url, 
        min_size=1, 
        max_size=20,
        max_lifetime=300,  # Recycle connections after 5 mins
