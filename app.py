...
def tool_node(state):
    ...
    # Force stop loop (Critical for Llama 3 stability)
...
def handle_ask():
    ...
    if "simple" in classification:
        ...
        # Force the agent to use tools if info is unknown
        ...
        2. Do not say "I don't know" or "My data is old". Search instead.
        3. Use coding tools for code requests.
        """)
